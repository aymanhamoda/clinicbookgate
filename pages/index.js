  ...
  return (
    <div className={styles.container}>
      ...
      <div className='byline' style={{ marginRight: '0' }}>
        <button
          onClick={() =>
            window.location.replace('http://clinicbook.org/register')
          }
        ...
        <span>
          ...
          <a style={{ color: 'tomato' }} href='http://clinicbook.org'>
            login here
          </a>
        </span>
      </div>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to <a href='http://clinicbook.org'>clinicbook.org</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href='http://clinicbook.org' className={styles.card}>
